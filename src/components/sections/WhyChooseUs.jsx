    ...
    <Section id="why-choose-us" bg="bg-transparent" className="!overflow-visible relative">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 opacity-100">
        ...
        <motion.img
          ...
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
          className="absolute sm:top-40 sm:-right-4 w-24 h-24 md:-top-[200px] md:-right-10 md:w-64 md:h-64 lg:-top-[480px] lg:-right-[110px] lg:w-[600px] lg:h-[600px] object-contain drop-shadow-xl hidden md:block"
          style={{ animation: 'float 2.5s ease-in-out infinite' }}
        />
      </div>
